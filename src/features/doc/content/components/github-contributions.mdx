...
The component uses the public GitHub Contributions API by default. Set the
variable below only when you need to override its base URL:

```bash title=".env.local"
# Optional: override the default public API endpoint
